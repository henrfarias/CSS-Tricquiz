...
import LoadingSkt from '../../components/LoadingSkt';
...
function QuestionWidget({
  ...
  const noAlternativeSelected = selectedAlternative === undefined;
  return (
    <Widget>
      <Widget.Header>
        <BackLinkArrow href="/" />
      ...
      <Widget.Content>
        ...
        >
          ...
          <Button type="submit" disabled={noAlternativeSelected}>
            Confirmar
          </Button>
